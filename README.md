...
> Five expert AI agents. Zero hosting costs. Install in 30 seconds.

---

## 🎯 What is AI-Squad?

AI-Squad is a **command-line tool** that brings five specialized AI agents to your project:
...
- 🎭 **UX Designer** - Creates wireframes, user flows, accessibility guidelines
- ✅ **Reviewer** - Reviews code, checks security, ensures quality
